...
public class MainLDATFIDFMth12 {
	public static void main(String[] args) {
		MainLDAMth6 main = new MainLDAMth6();
		
		// Location of the TFIDF vectors of LDA for 1 month
		//String tfidfVectorsFileMth1 = "C:/Users/L335A14/Desktop/LDATFIDFVectors/LDAmonth1vectorsTFIDF.txt";
		// Location of the dictionary file of the TFIDF vectors of LDA for 1 month
		//String tfidfDictFileMth1 = "C:/Users/L335A14/Desktop/LDATFIDFVectors/LDAmonth1vectorsTFIDFDict.txt";
		
		// Location of the TFIDF vectors of LDA for 6 month
		//String tfidfVectorsFileMth6 = "C:/Users/L335A14/Desktop/LDATFIDFVectors/LDAmonth6vectorsTFIDF.txt";
		// Location of the dictionary file of the TFIDF vectors of LDA for 6 month
		//String tfidfDictFileMth6 = "C:/Users/L335A14/Desktop/LDATFIDFVectors/LDAmonth6vectorsTFIDFDict.txt";
		
		// Location of the TFIDF vectors of LDA for 12 month
		String tfidfVectorsFileMth12 = "C:/Users/L335A14/Desktop/LDATFIDFVectors/LDAmonth12vectorsTFIDF.txt";
		// Location of the dictionary file of the TFIDF vectors of LDA for 12 month
		String tfidfDictFileMth12 = "C:/Users/L335A14/Desktop/LDATFIDFVectors/LDAmonth12vectorsTFIDFDict.txt";
		
		//System.out.println("LDA with TFIDF Month 1 S_Dbw: ");
		//main.calcLDAS_Dbw(tfidfVectorsFileMth1, tfidfDictFileMth1, 1, 1);

		//System.out.println("LDA with TFIDF Month 6 S_Dbw: ");
		//main.calcLDAS_Dbw(tfidfVectorsFileMth6, tfidfDictFileMth6, 6, 1);

		System.out.println("LDA with TFIDF Month 12 S_Dbw: ");
		main.calcLDAS_Dbw(tfidfVectorsFileMth12, tfidfDictFileMth12, 12, 1);
	}
