...
public class RetrieveVectorsLDA {		
	...
	public int getNoOfClusters(ArrayList<String> temp) {
		int result = 0;
		ArrayList<Integer> tempList = new ArrayList<Integer>();
		
		for (int i = 0; i < temp.size(); i++) {
			int clusterNum = Integer.parseInt(temp.get(i).substring(temp.get(i).indexOf(":") + 1, temp.get(i).length())) + 1;
